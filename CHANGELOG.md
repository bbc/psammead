...
| Version | Description |
|---------|-------------|
| 1.7.16 | [PR#2138](https://github.com/bbc/psammead/pull/2138) Talos - Bump Dependencies - @storybook/addon-a11y, @storybook/addon-actions, @storybook/addon-knobs, @storybook/addon-notes, @storybook/addon-viewport, @storybook/react, @storybook/theming, eslint, eslint-config-prettier, stylelint-config-recommended |

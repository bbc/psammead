...
| Version | Description |
|---------|-------------|
| 1.8.5 | [PR#22--](https://github.com/bbc/psammead/pull/22--) Bumping dependencies - @storybook/theming, @storybook/react, @storybook/addon-notes, @storybook/knobs, @storybook/addon-a11y, @storybook/addon-actions, @storybook/addon-viewport, eslint-plugin-prettier, enquirer, lint-staged |

...
| Version | Description |
|---------|-------------|
| 1.4.2  | [PR#1566](https://github.com/bbc/psammead/pull/1566) Bump storybook-readme, storybook-chromatic, @storybook/addon-notes, @storybook/addon-viewport, @storybook/react, gh-pages, @storybook/addon-knobs, @storybook/addon-actions, @bbc/psammead-assets |

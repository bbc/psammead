...
| Version | Description |
|---------|-------------|
| 2.0.61 | [PR#2998](https://github.com/bbc/psammead/pull/2998) Remove unused package and update `psammead-test-helpers` to use the latest `jest-styled-components |

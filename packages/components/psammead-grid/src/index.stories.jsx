  ...
  <Grid columns={{ group3: 6, group4: 8 }}>
    <Grid item columns={{ group3: 6, group4: 6 }}>
      <p>
        ...
        columns. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
...
export const simpleExampleUsingGelGuttersAndGelMargins = () => (
...
simpleExampleUsingGelGuttersAndGelMargins.story = {
  name: 'Simple example using gelGutters and gelMargins',
  parameters: { notes, knobs: { escapeHTML: false } },
};

export const simpleExampleWithUsingAnOffset = () => (
  <Grid
...
simpleExampleWithUsingAnOffset.story = {
  name: 'Simple example with using an offset',
  parameters: { notes, knobs: { escapeHTML: false } },
};

export const sliceLayoutFor6Or10Items = () => (
...
sliceLayoutFor6Or10Items.story = {
  name: 'Slice layout for 6 or 10 items',
  parameters: { notes, knobs: { escapeHTML: false } },
};

export const topStorySliceLayout = () => (
  <Grid
...
topStorySliceLayout.story = {
  name: 'Top story slice layout',
  parameters: { notes, knobs: { escapeHTML: false } },
};

export const normalSliceLayoutFor1Or5Items = () => (
  <Grid
    columns={{ group1: 6, group2: 6, group3: 6, group4: 8, group5: 8 }}
    enableGelGutters
    enableGelMargins
...
normalSliceLayoutFor1Or5Items.story = {
  name: 'Normal slice layout for 1 or 5 items',
  parameters: { notes, knobs: { escapeHTML: false } },
};

export const normalSliceLayoutFor26Or10Items = () => (
  <Grid columns={{ group4: 8 }} enableGelGutters enableGelMargins>
...
normalSliceLayoutFor26Or10Items.story = {
  name: 'Normal slice layout for 2, 6 or 10 items',
  parameters: { notes, knobs: { escapeHTML: false } },
};

export const normalSliceLayoutFor4Or8Items = () => (
  <Grid columns={{ group4: 8 }} enableGelGutters enableGelMargins>
    <Grid item columns={{ group4: 2 }}>
      <ExampleImage />
      <ExampleParagraph identifier="1" />
...
normalSliceLayoutFor4Or8Items.story = {
  name: 'Normal slice layout for 4 or 8 items',
  parameters: { notes, knobs: { escapeHTML: false } },
};

export const singleGroupGroup2 = () => (
...
singleGroupGroup2.story = {
  name: 'Single group - group2',
  parameters: { notes },
};

export const gridArticleImageExample = () => (
  <Grid
    columns={{ group1: 6, group2: 6, group3: 6, group4: 8, group5: 20 }}
    enableGelMargins
    enableGelGutters
...
gridArticleImageExample.story = {
  name: 'Grid Article image example',
  parameters: { notes },
};

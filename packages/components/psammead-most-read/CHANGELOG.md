...
| Version | Description |
|---------|-------------|
| 0.5.0-alpha.1 | [PR#2869](https://github.com/bbc/psammead/pull/2869) Update the prop structure of most-read component, to treat items independently. |
| 0.4.0-alpha.1 | [PR#2860](https://github.com/bbc/psammead/pull/2860) Update props for MostReadItem and update Readme |

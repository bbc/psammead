...
The `SocialEmbed` component renders a rich Social Embed from a list of supported providers, or a fallback.
...
```
import SocialEmbed from "@bbc/psammead-social-embed"
```

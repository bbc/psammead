...
| Version | Description |
|---------|-------------|
| 3.0.2 | [PR#3927](https://github.com/bbc/psammead/pull/3927) Remove styled-component 'referencing other components' comment and reenabled stylelint for the style block that references another component |

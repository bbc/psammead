...
storiesOf('Brand', module)
  ...
  .add(
    'default',
    () => {
      const choice = select('SVG', Object.keys(svgs), 'News');
      const svgWidth = number('SVG Width', 167.95);
      return (
        <Brand brandName="Default Brand Name" svgWidth={svgWidth}>
          {svgs[choice]}
        </Brand>
      );
    },

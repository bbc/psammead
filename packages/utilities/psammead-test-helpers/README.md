...
This package is a collection helper methods uses for snapshot testing with support for styled components.
...
There is currently a plan to migrate from `react-test-renderer` to `enzyme`.

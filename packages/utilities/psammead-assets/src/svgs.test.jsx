...
import { news, yoruba, igbo, pidgin, thai, persian } from './svgs';
...
describe('Persian Svg', () => {
  shouldMatchSnapshot(
    'should render persian svg correctly',
    <svg viewBox={`${persian.viewbox.width} ${persian.viewbox.height}`}>
      {persian.group}
    </svg>,
  );
});
